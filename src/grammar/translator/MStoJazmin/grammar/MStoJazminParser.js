// Generated from ./grammar/MStoJazmin.g4 by ANTLR 4.13.1
// jshint ignore: start
import antlr4 from 'antlr4';
import MStoJazminVisitor from './MStoJazminVisitor.js';
...
export default class MStoJazminParser extends antlr4.Parser {

    static grammarFileName = "MStoJazmin.g4";
    ...
    constructor(input) {
        ...
        this.ruleNames = MStoJazminParser.ruleNames;
        this.literalNames = MStoJazminParser.literalNames;
        this.symbolicNames = MStoJazminParser.symbolicNames;
    }
	...
	file() {
	    ...
	    this.enterRule(localctx, 0, MStoJazminParser.RULE_file);
	    var _la = 0;
	    try {
	...
	init() {
	    ...
	    this.enterRule(localctx, 2, MStoJazminParser.RULE_init);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 37;
	        this.match(MStoJazminParser.MAIN);
	        this.state = 38;
	        this.match(MStoJazminParser.OPEN_CURL);
	        this.state = 40;
	        this._errHandler.sync(this);
	        var la_ = this._interp.adaptivePredict(this._input,1,this._ctx);
	        if(la_===1) {
	            this.state = 39;
	            this.match(MStoJazminParser.T__0);
	        ...
	        this.state = 46;
	        this.match(MStoJazminParser.CLOSE_CURL);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	logic() {
	    ...
	    this.enterRule(localctx, 4, MStoJazminParser.RULE_logic);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 51;
	        this._errHandler.sync(this);
	...
	expression() {
	    ...
	    this.enterRule(localctx, 6, MStoJazminParser.RULE_expression);
	    var _la = 0;
	    try {
	        this.state = 86;
	        this._errHandler.sync(this);
	        ...
	        case 1:
	            ...
	            if(_la===27) {
	                this.state = 55;
	                this.match(MStoJazminParser.SEMI);
	            }
	...
	declaration() {
	    ...
	    this.enterRule(localctx, 8, MStoJazminParser.RULE_declaration);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 88;
	        this.match(MStoJazminParser.TYPE);
	        this.state = 89;
	        this.match(MStoJazminParser.ID);
	        this.state = 92;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===8) {
	            this.state = 90;
	            this.match(MStoJazminParser.EQUALS);
	            this.state = 91;
	            this.value(0);
	        }
	...
	assign() {
	    ...
	    this.enterRule(localctx, 10, MStoJazminParser.RULE_assign);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 94;
	        this.match(MStoJazminParser.ID);
	...
	log() {
	    ...
	    this.enterRule(localctx, 12, MStoJazminParser.RULE_log);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 98;
	        this.match(MStoJazminParser.PRINT);
	        this.state = 99;
	        this.match(MStoJazminParser.OPEN_PARENTH);
	        this.state = 100;
	        this.value(0);
	        this.state = 101;
	        this.match(MStoJazminParser.CLOSE_PARENTH);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	value(_p) {
	    ...
	    this.enterRecursionRule(localctx, 14, MStoJazminParser.RULE_value, _p);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 116;
	        ...
	        case 23:
	            ...
	            _prevctx = localctx;
	            this.state = 111;
	            this.match(MStoJazminParser.STRING);
	            break;
	        case 24:
	            localctx = new ValueAsCharContext(this, localctx);
	            this._ctx = localctx;
	            _prevctx = localctx;
	            this.state = 112;
	            this.match(MStoJazminParser.CHAR);
	            break;
	        case 26:
	            ...
	            _prevctx = localctx;
	            this.state = 113;
	            this.match(MStoJazminParser.FLOAT);
	            break;
	        case 25:
	            localctx = new ValueAsNumberContext(this, localctx);
	            this._ctx = localctx;
	            _prevctx = localctx;
	            this.state = 114;
	            this.match(MStoJazminParser.INT);
	            break;
	        case 29:
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 1:
	                    ...
	                    this.pushNewRecursionContext(localctx, _startState, MStoJazminParser.RULE_value);
	                    this.state = 118;
	...
	increment() {
	    ...
	    this.enterRule(localctx, 16, MStoJazminParser.RULE_increment);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 132;
	        this.match(MStoJazminParser.ID);
	        ...
	        case 9:
	            this.state = 133;
	            this.match(MStoJazminParser.PLUS);
	            this.state = 134;
	            this.match(MStoJazminParser.PLUS);
	            break;
	        case 10:
	            this.state = 135;
	            this.match(MStoJazminParser.SUB);
	            this.state = 136;
	            this.match(MStoJazminParser.SUB);
	            break;
	        default:
	...
	chained_conditional() {
	    ...
	    this.enterRule(localctx, 18, MStoJazminParser.RULE_chained_conditional);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 139;
	...
	conditional() {
	    ...
	    this.enterRule(localctx, 20, MStoJazminParser.RULE_conditional);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 149;
	        this.match(MStoJazminParser.IF_PR);
	        this.state = 150;
	        this.match(MStoJazminParser.OPEN_PARENTH);
	        this.state = 151;
	        this.value(0);
	...
	conditional__elif() {
	    ...
	    this.enterRule(localctx, 22, MStoJazminParser.RULE_conditional__elif);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 162;
	        this.match(MStoJazminParser.ELSE_PR);
	        this.state = 163;
	        this.conditional();
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
	...
	conditional__else() {
	    ...
	    this.enterRule(localctx, 24, MStoJazminParser.RULE_conditional__else);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 165;
	...
	loop__while() {
	    ...
	    this.enterRule(localctx, 26, MStoJazminParser.RULE_loop__while);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 175;
	        this.match(MStoJazminParser.WHILE_PR);
	        this.state = 176;
	        this.match(MStoJazminParser.OPEN_PARENTH);
	        this.state = 177;
	        this.value(0);
	...
	loop__for() {
	    ...
	    this.enterRule(localctx, 28, MStoJazminParser.RULE_loop__for);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 188;
	        this.match(MStoJazminParser.FOR_PR);
	        this.state = 189;
	        this.match(MStoJazminParser.OPEN_PARENTH);
	        this.state = 190;
	        this.declaration();
	...
	loop__do_while() {
	    ...
	    this.enterRule(localctx, 30, MStoJazminParser.RULE_loop__do_while);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 206;
	        this.match(MStoJazminParser.DO_PR);
	        this.state = 207;
	        this.match(MStoJazminParser.OPEN_CURL);
	        this.state = 211;
	        this._errHandler.sync(this);
...
MStoJazminParser.EOF = antlr4.Token.EOF;
MStoJazminParser.T__0 = 1;
MStoJazminParser.MAIN = 2;
MStoJazminParser.TYPE = 3;
MStoJazminParser.OPEN_PARENTH = 4;
MStoJazminParser.CLOSE_PARENTH = 5;
MStoJazminParser.OPEN_CURL = 6;
MStoJazminParser.CLOSE_CURL = 7;
MStoJazminParser.EQUALS = 8;
MStoJazminParser.PLUS = 9;
MStoJazminParser.SUB = 10;
MStoJazminParser.MULT = 11;
MStoJazminParser.MOD = 12;
MStoJazminParser.COMMA = 13;
MStoJazminParser.PRINT = 14;
MStoJazminParser.DIV = 15;
MStoJazminParser.IF_PR = 16;
MStoJazminParser.ELSE_PR = 17;
MStoJazminParser.WHILE_PR = 18;
MStoJazminParser.FOR_PR = 19;
MStoJazminParser.DO_PR = 20;
MStoJazminParser.COND_MAT = 21;
MStoJazminParser.COND_LOG = 22;
MStoJazminParser.STRING = 23;
MStoJazminParser.CHAR = 24;
MStoJazminParser.INT = 25;
MStoJazminParser.FLOAT = 26;
MStoJazminParser.SEMI = 27;
MStoJazminParser.NEWLINE = 28;
MStoJazminParser.ID = 29;
MStoJazminParser.WS = 30;

MStoJazminParser.RULE_file = 0;
MStoJazminParser.RULE_init = 1;
MStoJazminParser.RULE_logic = 2;
MStoJazminParser.RULE_expression = 3;
MStoJazminParser.RULE_declaration = 4;
MStoJazminParser.RULE_assign = 5;
MStoJazminParser.RULE_log = 6;
MStoJazminParser.RULE_value = 7;
MStoJazminParser.RULE_increment = 8;
MStoJazminParser.RULE_chained_conditional = 9;
MStoJazminParser.RULE_conditional = 10;
MStoJazminParser.RULE_conditional__elif = 11;
MStoJazminParser.RULE_conditional__else = 12;
MStoJazminParser.RULE_loop__while = 13;
MStoJazminParser.RULE_loop__for = 14;
MStoJazminParser.RULE_loop__do_while = 15;
...
class FileContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_file;
    }
	...
	accept(visitor) {
	    if ( visitor instanceof MStoJazminVisitor ) {
...
class InitContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_init;
    }

	MAIN() {
	    return this.getToken(MStoJazminParser.MAIN, 0);
	};

	OPEN_CURL() {
	    return this.getToken(MStoJazminParser.OPEN_CURL, 0);
	};
	...
	CLOSE_CURL() {
	    return this.getToken(MStoJazminParser.CLOSE_CURL, 0);
	};
...
class LogicContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_logic;
    }
...
class ExpressionContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_expression;
    }
	...
	SEMI() {
	    return this.getToken(MStoJazminParser.SEMI, 0);
	};
...
class DeclarationContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_declaration;
    }

	TYPE() {
	    return this.getToken(MStoJazminParser.TYPE, 0);
	};

	ID() {
	    return this.getToken(MStoJazminParser.ID, 0);
	};

	EQUALS() {
	    return this.getToken(MStoJazminParser.EQUALS, 0);
	};
...
class AssignContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_assign;
    }
...
class LogContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_log;
    }

	PRINT() {
	    return this.getToken(MStoJazminParser.PRINT, 0);
	};

	OPEN_PARENTH() {
	    return this.getToken(MStoJazminParser.OPEN_PARENTH, 0);
	};
	...
	CLOSE_PARENTH() {
	    return this.getToken(MStoJazminParser.CLOSE_PARENTH, 0);
	};
...
class ValueContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_value;
    }
...
MStoJazminParser.ParenthesesContext = ParenthesesContext;
...
class ValueAsCharContext extends ValueContext {
	...
	STRING() {
	    return this.getToken(MStoJazminParser.STRING, 0);
	};

	CHAR() {
	    return this.getToken(MStoJazminParser.CHAR, 0);
	};
...
MStoJazminParser.ValueAsCharContext = ValueAsCharContext;
...
class MultDivContext extends ValueContext {
	...
	MULT() {
	    return this.getToken(MStoJazminParser.MULT, 0);
	};

	DIV() {
	    return this.getToken(MStoJazminParser.DIV, 0);
	};

	MOD() {
	    return this.getToken(MStoJazminParser.MOD, 0);
	};
...
MStoJazminParser.MultDivContext = MultDivContext;
...
class NormalConditionContext extends ValueContext {
	...
	COND_LOG() {
	    return this.getToken(MStoJazminParser.COND_LOG, 0);
	};

	COND_MAT() {
	    return this.getToken(MStoJazminParser.COND_MAT, 0);
	};
...
MStoJazminParser.NormalConditionContext = NormalConditionContext;
...
class AddSubContext extends ValueContext {
	...
	PLUS() {
	    return this.getToken(MStoJazminParser.PLUS, 0);
	};

	SUB() {
	    return this.getToken(MStoJazminParser.SUB, 0);
	};
...
MStoJazminParser.AddSubContext = AddSubContext;
...
class ValueAsNumberContext extends ValueContext {
	...
	FLOAT() {
	    return this.getToken(MStoJazminParser.FLOAT, 0);
	};

	INT() {
	    return this.getToken(MStoJazminParser.INT, 0);
	};
...
MStoJazminParser.ValueAsNumberContext = ValueAsNumberContext;
...
MStoJazminParser.SignNumbersContext = SignNumbersContext;
...
MStoJazminParser.ValueAsIDContext = ValueAsIDContext;
...
class IncrementContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_increment;
    }
	...
	PLUS = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(MStoJazminParser.PLUS);
	    } else {
	        return this.getToken(MStoJazminParser.PLUS, i);
	    }
	};
	...
	SUB = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(MStoJazminParser.SUB);
	    } else {
	        return this.getToken(MStoJazminParser.SUB, i);
	    }
	};
...
class Chained_conditionalContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_chained_conditional;
    }
...
class ConditionalContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_conditional;
    }

	IF_PR() {
	    return this.getToken(MStoJazminParser.IF_PR, 0);
	};
...
class Conditional__elifContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_conditional__elif;
    }

	ELSE_PR() {
	    return this.getToken(MStoJazminParser.ELSE_PR, 0);
	};
...
class Conditional__elseContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_conditional__else;
    }
...
class Loop__whileContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_loop__while;
    }

	WHILE_PR() {
	    return this.getToken(MStoJazminParser.WHILE_PR, 0);
	};
...
class Loop__forContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_loop__for;
    }

	FOR_PR() {
	    return this.getToken(MStoJazminParser.FOR_PR, 0);
	};
	...
	SEMI = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(MStoJazminParser.SEMI);
	    } else {
	        return this.getToken(MStoJazminParser.SEMI, i);
	    }
	};
...
class Loop__do_whileContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = MStoJazminParser.RULE_loop__do_while;
    }

	DO_PR() {
	    return this.getToken(MStoJazminParser.DO_PR, 0);
	};
...
MStoJazminParser.FileContext = FileContext; 
MStoJazminParser.InitContext = InitContext; 
MStoJazminParser.LogicContext = LogicContext; 
MStoJazminParser.ExpressionContext = ExpressionContext; 
MStoJazminParser.DeclarationContext = DeclarationContext; 
MStoJazminParser.AssignContext = AssignContext; 
MStoJazminParser.LogContext = LogContext; 
MStoJazminParser.ValueContext = ValueContext; 
MStoJazminParser.IncrementContext = IncrementContext; 
MStoJazminParser.Chained_conditionalContext = Chained_conditionalContext; 
MStoJazminParser.ConditionalContext = ConditionalContext; 
MStoJazminParser.Conditional__elifContext = Conditional__elifContext; 
MStoJazminParser.Conditional__elseContext = Conditional__elseContext; 
MStoJazminParser.Loop__whileContext = Loop__whileContext; 
MStoJazminParser.Loop__forContext = Loop__forContext; 
MStoJazminParser.Loop__do_whileContext = Loop__do_whileContext; 
